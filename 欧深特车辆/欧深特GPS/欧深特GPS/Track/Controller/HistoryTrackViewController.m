    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
        ...
        if ([[dic objectForKey:@"success"] boolValue] == YES) {
            ...
            for (NSDictionary *dic in locationArr) {
                ...
                [self.plistArr addObject:DataDic];
            }
...
- (void)setupView{
    ...
    UIView *toolView0 = [[UIView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height  - 40, WindowWidth, 40)];
...
//    [toolView0 addSubview:line0];
    ...
    UIButton *StopBtn = [[UIButton alloc]initWithFrame:CGRectMake(50,64, 38, 38)];
    StopBtn.center = CGPointMake(WindowWidth/2, 20);
//    [StopBtn setTitle:NSLocalizedString(@"HistoryTrackViewController_Pause", "暂停") forState:UIControlStateNormal];
    ...
    UIButton *startBtn = [[UIButton alloc]initWithFrame:CGRectMake(0,64, 38, 38)];
    startBtn.center = CGPointMake(WindowWidth/2 - 80, 20);
    ...
    UIButton *restartBtn = [[UIButton alloc]initWithFrame:CGRectMake(0,64, 38, 38)];
    restartBtn.center = CGPointMake(WindowWidth/2 + 80, 20);
...
- (void)addmapAnimation{
    ...
    for (int i = 0; i < self.plistArr.count; i++) {
        ...
        CLLocationCoordinate2D coordinate = CLLocationCoordinate2DMake([[latlonDic objectForKey:@"lat"] doubleValue],[[latlonDic objectForKey:@"lon"] doubleValue]);
