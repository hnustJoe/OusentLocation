...
- (void)viewDidLoad {
    ...
    UITextField *usernameTextField = [[UITextField alloc]initWithFrame:CGRectMake(backBtn.frame.origin.x, CGRectGetMaxY(backBtn.frame) + 40, WindowWidth - 40, 44)];
    ...
    UITextField *emailTextField = [[UITextField alloc]initWithFrame:CGRectMake(backBtn.frame.origin.x, CGRectGetMaxY(usernameTextField.frame), WindowWidth - 40, 44)];
    ...
    UITextField *ensureCodeTextField = [[UITextField alloc]initWithFrame:CGRectMake(backBtn.frame.origin.x, CGRectGetMaxY(emailTextField.frame), WindowWidth - 40, 44)];
    ensureCodeTextField.placeholder = NSLocalizedString(@"RegisterViewController_ensureCode", "ensureCode");
    ...
    UITextField *phoneTextField = [[UITextField alloc]initWithFrame:CGRectMake(backBtn.frame.origin.x, CGRectGetMaxY(ensureCodeTextField.frame), WindowWidth - 40, 44)];
    ...
    UITextField *passwordTextField = [[UITextField alloc]initWithFrame:CGRectMake(backBtn.frame.origin.x, CGRectGetMaxY(phoneTextField.frame), WindowWidth - 40, 44)];
    ...
    UITextField *secondPasswordTextField = [[UITextField alloc]initWithFrame:CGRectMake(backBtn.frame.origin.x, CGRectGetMaxY(passwordTextField.frame), WindowWidth - 40, 44)];
...
- (void)testCodeBtn_clicked{
    ...
    NSString *str = [NSString stringWithFormat:@"http://%@/MobileHome.mvc/SendEmailCode?SendEmailCode=%@&code=%@",[CommonFunction getloginIP],self.emailTextField.text,self.testCode];
    NSString* encodedString = [str stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    NSURL *url = [NSURL URLWithString:encodedString];
    NSURLRequest *urlQuest = [[NSURLRequest alloc]initWithURL:url];
    AFHTTPRequestOperation *operation = [[AFHTTPRequestOperation alloc]initWithRequest:urlQuest];
