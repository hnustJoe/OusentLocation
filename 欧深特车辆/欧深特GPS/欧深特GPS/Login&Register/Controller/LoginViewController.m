...
- (void)loginBtn_clicked:(UIButton *)sender{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://%@/MobileHome.mvc/Login?username=%@&password=%@",self.serverBtn.titleLabel.text,self.nickNameTextField.text,self.passwordTextField.text]];
