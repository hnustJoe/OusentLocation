...
@interface TrackViewController ()<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate>
...
- (void)rightAction{
    ...
    NSString *str = [NSString stringWithFormat:@"http://%@/MobileCommand.mvc/Send?vehicleId=%@&paramIds=%@&paramValues=%@",[CommonFunction getloginIP],[CommonFunction getCurrentVehicleId],@"73,29",paramValue];
