...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            ...
            case 1:{
                cell.textLabel.text = NSLocalizedString(@"SettingViewController_APNList", "APN列表");
                cell.accessoryType = UITableViewCellAccessoryDisclosureIndicator;
            }break;
            case 2:{
                cell.textLabel.text = NSLocalizedString(@"SettingViewController_APPVersion", "APP版本");
                cell.detailTextLabel.text = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"];            }break;
            default:
                break;
        }
