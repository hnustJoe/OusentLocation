...
//    pickView.frame=CGRectMake(0, ZHToobarHeight, pickView.frame.size.width, pickView.frame.size.height);
    pickView.frame=CGRectMake(0,WindowHeight -  ZHToobarHeight, pickView.frame.size.width, pickView.frame.size.height);
...
//    datePicker.frame=CGRectMake(0, ZHToobarHeight, WindowWidth, datePicker.frame.size.height);
    datePicker.frame=CGRectMake(0,WindowHeight -  datePicker.frame.size.height, WindowWidth, datePicker.frame.size.height);

    _toolbar.frame=CGRectMake(0, WindowHeight - ZHToobarHeight -  datePicker.frame.size.height,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
    _pickeviewHeight=datePicker.frame.size.height;
    
    
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, WindowHeight, WindowHeight)];
...
-(UIToolbar *)setToolbarStyle{
    ...
    UIBarButtonItem *lefttem=[[UIBarButtonItem alloc] initWithTitle:[NSString stringWithFormat:@"  %@",NSLocalizedString(@"cancel", nil)] style:UIBarButtonItemStylePlain target:self action:@selector(remove)];
    
    UIBarButtonItem *centerSpace=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    
    UIBarButtonItem *right=[[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"ensure", nil) style:UIBarButtonItemStylePlain target:self action:@selector(doneClick)];
...
-(void)remove{
    [UIView animateWithDuration:0.2 animations:^{
        _datePicker.frame=CGRectMake(0,WindowHeight, WindowWidth, _datePicker.frame.size.height);
        _toolbar.frame=CGRectMake(0, WindowHeight,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
...
-(void)show{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        _datePicker.frame=CGRectMake(0,WindowHeight -  _datePicker.frame.size.height, WindowWidth, _datePicker.frame.size.height);
        _toolbar.frame=CGRectMake(0, WindowHeight - ZHToobarHeight -  _datePicker.frame.size.height,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
