...
+ (void)saveCurrentVehicleLat:(NSString *)lat{
    [[NSUserDefaults standardUserDefaults]setObject:lat forKey:@"CurrentVehicleLat"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
+ (NSString *)getCurrentVehicleLat{
    return [[NSUserDefaults standardUserDefaults]objectForKey:@"CurrentVehicleLat"];
}

+ (void)saveCurrentVehicleLng:(NSString *)lng{
    [[NSUserDefaults standardUserDefaults]setObject:lng forKey:@"CurrentVehicleLng"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
+ (NSString *)getCurrentVehicleLng{
    return [[NSUserDefaults standardUserDefaults]objectForKey:@"CurrentVehicleLng"];
}



+ (void)saveCurrentdriver:(NSString *)driver{
    if (![driver isKindOfClass:[NSNull class]]) {
        [[NSUserDefaults standardUserDefaults]setObject:driver forKey:@"driver"];
        [[NSUserDefaults standardUserDefaults] synchronize];
    }
...
+ (NSString *)getCurrentdriver{
    return [[NSUserDefaults standardUserDefaults]objectForKey:@"driver"];
}

+ (void)saveCurrenttermNo:(NSString *)termNo{
    if (![termNo isKindOfClass:[NSNull class]]) {
        [[NSUserDefaults standardUserDefaults]setObject:termNo forKey:@"termNo"];
        [[NSUserDefaults standardUserDefaults] synchronize];

    }
}
+ (NSString *)getCurrenttermNo{
    return [[NSUserDefaults standardUserDefaults]objectForKey:@"termNo"];
}


+ (void)saveCurrentplateNo:(NSString *)CurrentplateNo{
    if (![CurrentplateNo isKindOfClass:[NSNull class]]) {
...
+ (void)saveCarListSelectIndex:(NSInteger)selectIndex{
    [[NSUserDefaults standardUserDefaults]setObject:[NSNumber numberWithInteger:selectIndex] forKey:@"CarListSelectIndex"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
+ (NSInteger)getCarListSelectIndex{
    return [[[NSUserDefaults standardUserDefaults]objectForKey:@"CarListSelectIndex"] integerValue];
}
...
//    [[NSUserDefaults standardUserDefaults]setObject:arr forKey:@"CarListArr"];
//    [[NSUserDefaults standardUserDefaults] synchronize];
//}
//+ (NSMutableArray *)getCarListArr{
//    return [[NSUserDefaults standardUserDefaults]objectForKey:@"CarListArr"];
//}
